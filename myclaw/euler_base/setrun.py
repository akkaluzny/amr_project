...
#------------------------------
    ...
    clawdata.num_cells[0] = 320      # mx
    clawdata.num_cells[1] = 320      # my
    ...
    n = 0
    nGauges = 5
    x_inc = (clawdata.upper[0] - clawdata.lower[0]) / (nGauges+1)
    y_inc = (clawdata.upper[1] - clawdata.lower[1]) / (nGauges+1)
    for ii in range(1,nGauges+1):
        for jj in range(1,nGauges+1):
            rundata.gaugedata.gauges.append([n, clawdata.lower[0]+ii*x_inc,
                                             clawdata.lower[1]+jj*y_inc, 
                                             0., 3.])
            n = n+1
            print '({}, {})'.format(clawdata.lower[0]+ii*x_inc, 
                                    clawdata.lower[1]+jj*y_inc)
            print 'n={}'.format(n)
